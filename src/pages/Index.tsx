          ...
          <div className="grid md:grid-cols-5 gap-12 md:gap-16 items-center">
            <div className="md:col-span-3 space-y-8 md:space-y-10">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.15]">
                <span className="animate-word mr-2">Что</span>
                <span className="animate-word mr-2">если</span>
                <span className="text-book-gold animate-word mr-1">«добро»</span>
                <span className="animate-word mr-1">,</span>
                <span className="animate-word mr-2">которому</span>
                <span className="animate-word mr-2">вас</span>
                <span className="animate-word mr-1">учили</span>
                <span className="animate-word mr-1">,</span>
                <br className="hidden md:block" />
                <span className="animate-word mr-2">на</span>
                <span className="animate-word mr-2">самом</span>
                <span className="animate-word mr-2">деле</span>
