    ...
    <>
      <section id="formats" className="py-12 md:py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid sm:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-12">
            <div className="p-8 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl border-2 border-gray-700 hover:border-book-gold transition-all hover:scale-105">
              <div className="text-center space-y-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold">ЭЛЕКТРОННАЯ КНИГА</h3>
                ...
                <div className="pt-3 sm:pt-4">
                  ...
                  <Button 
                    size="lg" 
                    className="w-full bg-book-gold hover:bg-book-red text-black hover:text-white font-bold text-xs sm:text-sm md:text-base py-4 sm:py-5"
            ...
            <div className="p-4 sm:p-6 md:p-8 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl border-2 border-gray-700 hover:border-book-gold transition-all hover:scale-105">
              <div className="text-center space-y-4 sm:space-y-6">
                <div className="text-4xl sm:text-5xl md:text-6xl mb-3 sm:mb-4">📖</div>
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold">БУМАЖНАЯ КНИГА</h3>
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-6 md:gap-8 text-xs sm:text-sm md:text-base">
      ...
      <section id="faq" className="py-12 md:py-20 px-4 bg-black/50">
        <div className="container mx-auto max-w-4xl">
          ...
          <Accordion type="single" collapsible className="space-y-3 sm:space-y-4">
            <AccordionItem value="item-1" className="bg-white/5 rounded-lg border border-gray-800 px-4 sm:px-6">
              <AccordionTrigger className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold hover:text-book-gold">
            ...
            <AccordionItem value="item-2" className="bg-white/5 rounded-lg border border-gray-800 px-4 sm:px-6">
              <AccordionTrigger className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold hover:text-book-gold">
            ...
            <AccordionItem value="item-3" className="bg-white/5 rounded-lg border border-gray-800 px-4 sm:px-6">
              <AccordionTrigger className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold hover:text-book-gold">
            ...
            <AccordionItem value="item-4" className="bg-white/5 rounded-lg border border-gray-800 px-4 sm:px-6">
              <AccordionTrigger className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold hover:text-book-gold">
            ...
            <AccordionItem value="item-5" className="bg-white/5 rounded-lg border border-gray-800 px-4 sm:px-6">
              <AccordionTrigger className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold hover:text-book-gold">
      ...
      <section id="final-cta" className="py-12 sm:py-16 md:py-20 lg:py-32 px-4">
        <div className="container mx-auto max-w-5xl text-center space-y-4 sm:space-y-6 md:space-y-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold leading-tight">
            Христианство — это не комфорт.<br className="hidden sm:block" />
          ...
          <Button 
            size="lg" 
            className="bg-book-red hover:bg-book-gold text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl px-6 sm:px-10 md:px-16 py-4 sm:py-6 md:py-8 mt-6 sm:mt-8 hover:scale-110 transition-all shadow-2xl w-full sm:w-auto"
          ...
          <div className="space-y-2 pt-4 sm:pt-6 text-xs sm:text-sm md:text-base text-gray-400">
            ...
            <p className="flex items-center justify-center gap-2">
              <Icon name="Check" size={16} className="text-book-gold flex-shrink-0" />
