          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-gray-400 text-sm">
                ...
                <a href="https://vk.ru/daryaserp" target="_blank" rel="noopener" className="hover:text-book-blue transition-colors block">📘 Личный VK Дарьи</a>
                <a href="https://youtube.com/@DaryaSerp" target="_blank" rel="noopener" className="hover:text-book-blue transition-colors block">▶️ Канал YouTube</a>
