...
export default function PhilosophySections({ scrollToSection }: PhilosophySectionsProps = {}) {
  ...
  return (
    <>
      ...
      <section id="thesis" className="py-20 md:py-32 px-4 bg-black/30">
        <div className="container mx-auto max-w-5xl">
          <Card className="bg-gradient-to-br from-gray-900 to-black border-2 border-book-red p-10 md:p-16">
            <CardContent className="space-y-10 p-0">
              <blockquote className="text-3xl md:text-4xl leading-relaxed font-quote space-y-6">
                <p>
