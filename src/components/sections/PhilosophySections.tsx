...
export default function PhilosophySections({ scrollToSection }: PhilosophySectionsProps = {}) {
  ...
  return (
    <>
      <section id="questions" className="py-12 md:py-24 px-4 bg-black/30">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mt-8 md:mt-12 space-y-4 md:space-y-6">
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto px-2">
              Эта книга не даёт утешительных ответов. Она показывает, как мораль служит не добру, а власти.
            </p>
            <button 
